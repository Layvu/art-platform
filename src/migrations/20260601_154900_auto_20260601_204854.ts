...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "home_slider" ADD CONSTRAINT "home_slider_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_home_slider_fk" FOREIGN KEY ("home_slider_id") REFERENCES "public"."home_slider"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "home_slider_image_idx" ON "home_slider" USING btree ("image_id");
  CREATE INDEX "home_slider_updated_at_idx" ON "home_slider" USING btree ("updated_at");
  CREATE INDEX "home_slider_created_at_idx" ON "home_slider" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_home_slider_id_idx" ON "payload_locked_documents_rels" USING btree ("home_slider_id");
